		...
		<div class="row">	
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Edit Idea</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Editing a Pitch</h3>
							<hr>
							
							<form method="POST" action="backend/editidea.php">
								...
								<div class="top-margin">
									...
									<textarea type="text" class="form-control" id="description" name="description" rows="6"><?php echo "\"" . $description . "\"";?></textarea>
